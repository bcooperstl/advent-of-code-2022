        ...
        for (int y=0; y<DAY_18_SIZE; y++)
        {
            for (int z=0; z<DAY_18_SIZE; z++)
            {
                if (cube->world[x+DAY_18_OFFSET][y+DAY_18_OFFSET][z+DAY_18_OFFSET] == DROP)
                {
                    ...
                    if (cube->world[x+DAY_18_OFFSET-1][y+DAY_18_OFFSET][z+DAY_18_OFFSET] != DROP)
                    {
#ifdef DEBUG_DAY_18
                    ...
                    if (cube->world[x+DAY_18_OFFSET][y+DAY_18_OFFSET-1][z+DAY_18_OFFSET] != DROP)
                    {
#ifdef DEBUG_DAY_18
                        printf(" Edge found and added at %d,%d,%d\n", x, y-1, z);
#endif
                    ...
                    if (cube->world[x+DAY_18_OFFSET][y+DAY_18_OFFSET][z+DAY_18_OFFSET-1] != DROP)
                    {
#ifdef DEBUG_DAY_18
                        printf(" Edge found and added at %d,%d,%d\n", x, y, z-1);
#endif
